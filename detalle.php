...
?>
  ...
  <div>
    <div class="container-fluid pt-4">
      <div class="row">
        <div class="col-md-12"><img class="img-fluid d-block mx-auto" src="img/<?= $row["imagen-principal"] ?>" width="100%"></div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <iframe src="audios/silence.mp3" allow="autoplay" id="audio" style="display:none"></iframe>
          <audio autoplay="" class="w-100" controls="">
            <source src="audios/<?= $row["audio"] ?>" type="audio/mpeg"> Your browser does not support the audio element. </audio>
        </div>
      </div>
    </div>
  </div>
  <div class="py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="mb-3"><?= $row["lugar"] ?></h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="row pb-3">
            <div class="col-md-1"><img class="img-fluid d-block rounded-circle mx-auto" src="img/<?= $row["imagen-secundaria"] ?>" alt="Card image cap" width="50"></div>
            <div class="col-md-11">
              <div class="col-9 col-md-12">
                <h6>Contenido generado por:<br><b><?php echo $row["generador-de-contenido"] ?></b>&nbsp;</h6>
              </div>
            </div>
          </div>
        </div>
